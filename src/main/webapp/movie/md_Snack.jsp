...
%>      
  ...
  <section class="serv_list">
  	<div class="container">
			<div class="title">
				<a href="./md_Drink.jsp">음료</a> | <span style="font-size:23pt; font-weight:bolder; color:IndianRed">스낵</span>
			</div>
			<div class="item_list">
				<div class="card">
					<div class="img">
						<img src="../images/md_pop_caramel.jpg">
					</div>
					<div class="text">
						<h3 class="card_title">카라멜 팝콘</h3>
						<p>6,000원</p>
					</div>
				</div>
			</div>  	<!-- .item_list END -->
				...
				<div class="card">
					<div class="img">
						<img src="../images/md_pop_plain.jpg">
					</div>
					<div class="text">
						<h3 class="card_title">고소 팝콘</h3>
						<p>5,000원</p>
					</div>
				</div>
			</div>  	<!-- .item_list END -->
				...
				<div class="card">
					<div class="img">
						<img src="../images/md_pop_dc.jpg">
					</div>
					<div class="text">
						<h3 class="card_title">더블치즈 팝콘</h3>
						<p>6,000원</p>
					</div>
				</div>
			</div>  	<!-- .item_list END -->
				...
				<div class="card">
					<div class="img">
						<img src="../images/md_pop_basil.jpg">
					</div>
					<div class="text">
						<h3 class="card_title">바질어니언 팝콘</h3>
						<p>6,000원</p>
					</div>
				</div>
			</div>  	<!-- .item_list END -->
			<div class="item_list">
				<div class="card">
					<div class="img">
						<img src="../images/md_snack_hotdog.jpg">
					</div>
					<div class="text">
						<h3 class="card_title">플레인 핫도그</h3>
						<p>6,000원</p>
					</div>
				</div>
			</div>  	<!-- .item_list END -->
			<div class="item_list">
				<div class="card">
					<div class="img">
						<img src="../images/md_snack_chilli.jpg">
					</div>
					<div class="text">
						<h3 class="card_title">칠리치즈 핫도그</h3>
						<p>6,000원</p>
					</div>
				</div>
			</div>  	<!-- .item_list END -->
			<div class="item_list">
				<div class="card">
					<div class="img">
						<img src="../images/md_snack_nacho.jpg">
					</div>
					<div class="text">
						<h3 class="card_title">칠리치즈맛 나쵸</h3>
						<p>6,000원</p>
					</div>
				</div>
			</div>  	<!-- .item_list END -->
